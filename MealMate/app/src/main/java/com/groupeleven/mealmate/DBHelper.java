...
public class DBHelper extends SQLiteOpenHelper{
    private static final String dbName = "UserIngredients.db";
    private static final int DATABASE_VERSION = 1;
    private static final String tableName = "user_ingredients";
    ...
    private static final String CREATE_TABLE = "CREATE TABLE " +  tableName + " (" +
            ...
            colName + " TEXT," + colQty + " INTEGER," + colCategory + " TEXT," + colUnit + " TEXT );";
